...
- Remove [js/test-runner.js](../js/test-runner.js) and its injection
...
**Remove:**
- [js/test-runner.js](../js/test-runner.js)
- `testRunnerScript` from [js/client.js](../js/client.js) lines 3, 147-148
- Import map entry `node:oyinbo/worker` (unused)
